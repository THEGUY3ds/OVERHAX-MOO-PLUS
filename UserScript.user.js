...
document.getElementById('promoImgHolder').innerHTML = '<iframe width=300" height="180" src="https://www.youtube.com/embed/g5_-zWYPcaY" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>';
document.getElementById("linksContainer2").innerHTML = '<a href="http://bit.ly/2m776HW">Get latest verson here!</a>';
document.getElementById("gameName").innerHTML = 'MOOPLUS';
document.getElementById("storeHolder").style = "height: 1500px; width: 450px;"

document.getElementById("_5b7c808047-199-1-container").remove();
